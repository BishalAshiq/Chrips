      ...
      <main className="flex flex-col pt-4 max-w-7xl mx-auto w-full h-full overflow-y-auto relative">
        ...
        <div className="relative flex py-2 items-center">
          ...
          <div className="">
            ...
            <span className={`inline-block px-1.5 py-.5 text-sm border mt-6 rounded mb-3 font-bold ${
              classification 
                ? 'border-green-900 text-green-900 bg-[#EDF9EA]'
                : 'border-[#FA4807] text-[#FA4807] bg-[#FFEBE3]'
            }`}>
              CLASSIFICATION: {classification ? 'TRUE' : 'FALSE'}
            </span>
            
            <p className="text-gray-700 mb-6">
              The statement &quot;The Earth is flat&quot; is scientifically false. There is overwhelming evidence from centuries of observation and modern science that the Earth is an oblate spheroid, meaning it is mostly spherical but slightly flattened at the poles and bulging at the equator. This has been confirmed by various methods, including satellite imagery, space exploration, and physical observations such as the curvature of the horizon and the way ships disappear hull-first as they move away.
            </p>

            <span className={`inline-block px-1.5 py-.5 text-sm border rounded mb-3 mt-7 font-bold ${
              accuracy_rating >= 6 
                ? 'border-green-900 text-green-900 bg-[#EDF9EA]'
                : 'border-[#FA4807] text-[#FA4807] bg-[#FFEBE3]'
            }`}>
              ACCURACY RATING: {accuracy_rating}/10
            </span>
